...
// Constants
// ---------------------------------------------------------------------------
export const ACTIVE_HOURS_RULE_ID = "ACTIVE_HOURS_V1";
 ...
 */
function nextActiveWindowISO(isoTimestamp) {
    try {
...
// Rule implementation
// ---------------------------------------------------------------------------
export const activeHoursRule = {
    id: ACTIVE_HOURS_RULE_ID,
    name: "Active Hours",
    version: "1.0.0",
    description: "Defers outbound messages sent outside the 08:00–20:59 WAT active window " +
    ...
    evaluate(ctx) {
        ...
        const isOutsideWindow = localHour !== null &&
