 ...
 */
export function invokeRule(rule, ctx, ruleIndex, budgetRemainingMs) {
...
function buildErrorTrace(traceId, rule, ctx, err, executionMs) {
    ...
    const stackTrace = err instanceof Error &&
