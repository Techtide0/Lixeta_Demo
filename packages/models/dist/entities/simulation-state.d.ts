...
export type SimulationStatus = "idle" | "initializing" | "running" | "paused" | "completed" | "failed" | "reset";
/**
 ...
 */
export type SimulationStateUpdate = Readonly<Partial<Omit<SimulationState, "id" | "config">>>;
