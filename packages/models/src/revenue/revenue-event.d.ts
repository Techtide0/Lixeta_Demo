 ...
 */
export type RevenueCategory = "sms_saved" | "sms_cost" | "transaction_fee" | "interchange" | "penalty" | "refund" | "bonus" | "subscription" | "other";
...
export interface RevenueAggregate {
    ...
    readonly byCategory: Readonly<Partial<Record<RevenueCategory, {
